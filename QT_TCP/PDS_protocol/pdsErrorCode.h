...
enum e_pdsErrorCode
{
    ...
    //Not enough pixels on the plane to estimate pose
    PDS_NOT_ENOUGH_PIXELS_ON_THE_PLANE=-1044,

    //Not enough pixels on the normal plane to estimate pose
    PDS_NOT_ENOUGH_PIXELS_ON_THE_Normal_PLANE=-1045,
